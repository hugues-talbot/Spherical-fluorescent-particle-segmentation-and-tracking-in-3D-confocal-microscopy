...
\end{figure}
    ...
    \item[{\bf ~~Why our approach is interesting:}] ~ %
      ...
      \item information is aggregated from 2D slices to find most likely
        position and radius by an optimization method;
    ...
    \item[{\bf ~~Key benefits:} ] ~\newline %
      our method 
      \begin{itemize}
      \item works on beads with imprecisely known radii
      \item can accurately segment, track and position 3D beads even
        in fluids
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width =  0.32\linewidth]{images/exp1_t41z4.png}}
\subfigure[]{\includegraphics[width =  0.32\linewidth]{images/exp1_t41z4_bin.png}}
\subfigure[]{\includegraphics[width =  0.32\linewidth]{images/surimp_exp1_t41z4.png}}
...
%        \end{description}
    ...
    \begin{column}{0.32\textwidth}
      ...
      \hfill
      %
            \begin{block}{\bf \color{white} Takeaway messages}
          \null\centering\relax
